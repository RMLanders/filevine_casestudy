...
left_table = pd.read_csv('./data/prediction/prediction_entity_df.csv')
# right_table = pd.read_csv('./data/oyez_judges_advocates_question_conclusion.csv')
right_table = pd.read_csv('./data/prediction/prediction_oyez_judges_advocates_question_conclusion.csv')
